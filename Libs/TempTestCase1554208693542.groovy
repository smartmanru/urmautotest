...
RunConfiguration.setExecutionSettingFile('C:\\Users\\1q\\AppData\\Local\\Temp\\Katalon\\Test Cases\\create_release_with_lifecycle\\20190402_153813\\execution.properties')
...
str(rel_version = WebUI.executeJavaScript('return(document.evaluate("//*/input[@testid=\\'urm-createversion-field\\']", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue).value', 
        []))
